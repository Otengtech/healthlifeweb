...
const MiddleSec = () => {
  ...
  return (
    <div className="w-full bg-gray-50 py-12 px-4 sm:px-6 lg:px-10">
      <div className="max-w-6xl mx-auto">
        {/* Section Title */}
        <motion.h2
          className="text-3xl sm:text-4xl md:text-5xl font-bold text-center text-green-700 mb-10"
        ...
        <div className="flex justify-center gap-6 sm:gap-10 border-b-2 border-green-100 mb-8 flex-wrap">
          {tabs.map(tab => (
            <button
              ...
              className={`relative pb-2 text-base sm:text-lg md:text-xl font-semibold transition-colors ${
            ...
            >
              {trendingReads.map(card => (
                <motion.div
                  ...
                  className="bg-white rounded-2xl overflow-hidden shadow-md flex flex-col transition-transform"
                >
                  ...
                  <div className="p-4 sm:p-6 flex flex-col flex-1">
                    ...
                    <Link
                      to="/blogpage"
                      className="mt-auto bg-green-500 text-gray-900 text-sm sm:text-base px-4 py-2 rounded hover:bg-green-400 transition font-medium text-center"
                    >
                      Read More
                    </Link>
                  </div>
              ...
              {healthPrograms.map(card => (
                ...
                >
                  ...
                  <div className="p-4 sm:p-6 flex flex-col flex-1">
                    ...
                    <button className="mt-auto bg-green-500 text-gray-900 text-sm sm:text-base px-4 py-2 rounded hover:bg-green-400 transition font-medium">
                      Read More
                    </button>
                  </div>
                </motion.div>
